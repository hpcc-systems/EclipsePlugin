...
public class ECLResult  implements java.io.Serializable {
    ...
    private wsworkunits.ws.hpccsystems.ECLSchemaItem[] ECLSchemas;
    ...
    public ECLResult(
           ...
           wsworkunits.ws.hpccsystems.ECLSchemaItem[] ECLSchemas) {
           this.name = name;
     ...
     * @return ECLSchemas
     */
    public wsworkunits.ws.hpccsystems.ECLSchemaItem[] getECLSchemas() {
        return ECLSchemas;
    }
     ...
     * @param ECLSchemas
     */
    public void setECLSchemas(wsworkunits.ws.hpccsystems.ECLSchemaItem[] ECLSchemas) {
        this.ECLSchemas = ECLSchemas;
    }
