...
public class WUCreateResponse  implements java.io.Serializable {
    ...
    private wsworkunits.ws.hpccsystems.ECLWorkunit workunit;
    ...
    public WUCreateResponse(
           ...
           wsworkunits.ws.hpccsystems.ECLWorkunit workunit) {
     ...
     * @return workunit
     */
    public wsworkunits.ws.hpccsystems.ECLWorkunit getWorkunit() {
        return workunit;
    }
     ...
     * @param workunit
     */
    public void setWorkunit(wsworkunits.ws.hpccsystems.ECLWorkunit workunit) {
        this.workunit = workunit;
    }
