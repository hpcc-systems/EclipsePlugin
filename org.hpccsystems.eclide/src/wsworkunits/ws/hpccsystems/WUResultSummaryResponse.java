...
public class WUResultSummaryResponse  implements java.io.Serializable {
    ...
    private wsworkunits.ws.hpccsystems.ECLResult result;
    ...
    public WUResultSummaryResponse(
           ...
           wsworkunits.ws.hpccsystems.ECLResult result) {
     ...
     * @return result
     */
    public wsworkunits.ws.hpccsystems.ECLResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(wsworkunits.ws.hpccsystems.ECLResult result) {
        this.result = result;
    }
