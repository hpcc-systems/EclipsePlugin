...
public class WUCompileECLResponse  implements java.io.Serializable {
    ...
    private wsworkunits.ws.hpccsystems.ECLException[] errors;

    private wsworkunits.ws.hpccsystems.WUECLAttribute[] dependencies;
    ...
    public WUCompileECLResponse(
           ...
           wsworkunits.ws.hpccsystems.ECLException[] errors,
           wsworkunits.ws.hpccsystems.WUECLAttribute[] dependencies) {
     ...
     * @return errors
     */
    public wsworkunits.ws.hpccsystems.ECLException[] getErrors() {
        return errors;
    }
     ...
     * @param errors
     */
    public void setErrors(wsworkunits.ws.hpccsystems.ECLException[] errors) {
        this.errors = errors;
    }
     ...
     * @return dependencies
     */
    public wsworkunits.ws.hpccsystems.WUECLAttribute[] getDependencies() {
        return dependencies;
    }
     ...
     * @param dependencies
     */
    public void setDependencies(wsworkunits.ws.hpccsystems.WUECLAttribute[] dependencies) {
        this.dependencies = dependencies;
    }
