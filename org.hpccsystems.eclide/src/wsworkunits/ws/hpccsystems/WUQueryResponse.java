...
public class WUQueryResponse  implements java.io.Serializable {
    ...
    private wsworkunits.ws.hpccsystems.ECLWorkunit[] workunits;
    ...
    public WUQueryResponse(
           ...
           wsworkunits.ws.hpccsystems.ECLWorkunit[] workunits) {
     ...
     * @return workunits
     */
    public wsworkunits.ws.hpccsystems.ECLWorkunit[] getWorkunits() {
        return workunits;
    }
     ...
     * @param workunits
     */
    public void setWorkunits(wsworkunits.ws.hpccsystems.ECLWorkunit[] workunits) {
        this.workunits = workunits;
    }
