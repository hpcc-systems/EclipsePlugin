...
public class ArrayOfEspException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    private wsworkunits.ws.hpccsystems.EspException[] exception;
    ...
    public ArrayOfEspException(
           ...
           wsworkunits.ws.hpccsystems.EspException[] exception) {
        this.source = source;
     ...
     * @return exception
     */
    public wsworkunits.ws.hpccsystems.EspException[] getException() {
        return exception;
    }
     ...
     * @param exception
     */
    public void setException(wsworkunits.ws.hpccsystems.EspException[] exception) {
        this.exception = exception;
    }

    public wsworkunits.ws.hpccsystems.EspException getException(int i) {
        return this.exception[i];
    }

    public void setException(int i, wsworkunits.ws.hpccsystems.EspException _value) {
