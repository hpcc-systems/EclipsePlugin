...
public class WUQuerysetsResponse  implements java.io.Serializable {
    ...
    private wsworkunits.ws.hpccsystems.QuerySet[] querysets;
    ...
    public WUQuerysetsResponse(
           ...
           wsworkunits.ws.hpccsystems.QuerySet[] querysets) {
     ...
     * @return querysets
     */
    public wsworkunits.ws.hpccsystems.QuerySet[] getQuerysets() {
        return querysets;
    }
     ...
     * @param querysets
     */
    public void setQuerysets(wsworkunits.ws.hpccsystems.QuerySet[] querysets) {
        this.querysets = querysets;
    }
