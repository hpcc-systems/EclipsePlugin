...
public class WUGetGraphResponse  implements java.io.Serializable {
    ...
    private wsworkunits.ws.hpccsystems.ECLGraphEx[] graphs;
    ...
    public WUGetGraphResponse(
           ...
           wsworkunits.ws.hpccsystems.ECLGraphEx[] graphs) {
     ...
     * @return graphs
     */
    public wsworkunits.ws.hpccsystems.ECLGraphEx[] getGraphs() {
        return graphs;
    }
     ...
     * @param graphs
     */
    public void setGraphs(wsworkunits.ws.hpccsystems.ECLGraphEx[] graphs) {
        this.graphs = graphs;
    }
