...
public class WUCopyLogicalClusterFileSections  implements java.io.Serializable {
    ...
    private wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] onCluster;

    private wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] notOnCluster;

    private wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] foreign;

    private wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] notFound;
    ...
    public WUCopyLogicalClusterFileSections(
           ...
           wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] onCluster,
           wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] notOnCluster,
           wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] foreign,
           wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] notFound) {
     ...
     * @return onCluster
     */
    public wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] getOnCluster() {
        return onCluster;
    }
     ...
     * @param onCluster
     */
    public void setOnCluster(wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] onCluster) {
        this.onCluster = onCluster;
    }
     ...
     * @return notOnCluster
     */
    public wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] getNotOnCluster() {
        return notOnCluster;
    }
     ...
     * @param notOnCluster
     */
    public void setNotOnCluster(wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] notOnCluster) {
        this.notOnCluster = notOnCluster;
    }
     ...
     * @return foreign
     */
    public wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] getForeign() {
        return foreign;
    }
     ...
     * @param foreign
     */
    public void setForeign(wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] foreign) {
        this.foreign = foreign;
    }
     ...
     * @return notFound
     */
    public wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] getNotFound() {
        return notFound;
    }
     ...
     * @param notFound
     */
    public void setNotFound(wsworkunits.ws.hpccsystems.WULogicalFileCopyInfo[] notFound) {
        this.notFound = notFound;
    }
