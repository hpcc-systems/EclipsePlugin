...
public class WsWorkunitsLocator extends org.apache.axis.client.Service implements wsworkunits.ws.hpccsystems.WsWorkunits {
    ...
    public wsworkunits.ws.hpccsystems.WsWorkunitsServiceSoap getWsWorkunitsServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public wsworkunits.ws.hpccsystems.WsWorkunitsServiceSoap getWsWorkunitsServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            wsworkunits.ws.hpccsystems.WsWorkunitsServiceSoapStub _stub = new wsworkunits.ws.hpccsystems.WsWorkunitsServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (wsworkunits.ws.hpccsystems.WsWorkunitsServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                wsworkunits.ws.hpccsystems.WsWorkunitsServiceSoapStub _stub = new wsworkunits.ws.hpccsystems.WsWorkunitsServiceSoapStub(new java.net.URL(WsWorkunitsServiceSoap_address), this);
                _stub.setPortName(getWsWorkunitsServiceSoapWSDDServiceName());
                return _stub;
            }
        }
