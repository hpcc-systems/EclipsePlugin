...
public class WUShowScheduledResponse  implements java.io.Serializable {
    ...
    private wsworkunits.ws.hpccsystems.ServerInfo[] clusters;

    private wsworkunits.ws.hpccsystems.ScheduledWU[] workunits;
    ...
    public WUShowScheduledResponse(
           ...
           wsworkunits.ws.hpccsystems.ServerInfo[] clusters,
           wsworkunits.ws.hpccsystems.ScheduledWU[] workunits) {
     ...
     * @return clusters
     */
    public wsworkunits.ws.hpccsystems.ServerInfo[] getClusters() {
        return clusters;
    }
     ...
     * @param clusters
     */
    public void setClusters(wsworkunits.ws.hpccsystems.ServerInfo[] clusters) {
        this.clusters = clusters;
    }
     ...
     * @return workunits
     */
    public wsworkunits.ws.hpccsystems.ScheduledWU[] getWorkunits() {
        return workunits;
    }
     ...
     * @param workunits
     */
    public void setWorkunits(wsworkunits.ws.hpccsystems.ScheduledWU[] workunits) {
        this.workunits = workunits;
    }
