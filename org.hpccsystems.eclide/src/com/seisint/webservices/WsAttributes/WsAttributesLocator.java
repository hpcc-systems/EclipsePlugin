...
public class WsAttributesLocator extends org.apache.axis.client.Service implements com.seisint.webservices.WsAttributes.WsAttributes {
    ...
    public com.seisint.webservices.WsAttributes.WsAttributesServiceSoap getWsAttributesServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.seisint.webservices.WsAttributes.WsAttributesServiceSoap getWsAttributesServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.seisint.webservices.WsAttributes.WsAttributesServiceSoapStub _stub = new com.seisint.webservices.WsAttributes.WsAttributesServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.seisint.webservices.WsAttributes.WsAttributesServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.seisint.webservices.WsAttributes.WsAttributesServiceSoapStub _stub = new com.seisint.webservices.WsAttributes.WsAttributesServiceSoapStub(new java.net.URL(WsAttributesServiceSoap_address), this);
                _stub.setPortName(getWsAttributesServiceSoapWSDDServiceName());
                return _stub;
            }
        }
