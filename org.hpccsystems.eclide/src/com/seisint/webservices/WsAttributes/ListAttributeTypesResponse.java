...
public class ListAttributeTypesResponse  implements java.io.Serializable {
    private com.seisint.webservices.WsAttributes.AttributeType[] types;

    public ListAttributeTypesResponse() {
    }

    public ListAttributeTypesResponse(
           com.seisint.webservices.WsAttributes.AttributeType[] types) {
           this.types = types;
    }
     ...
     * @return types
     */
    public com.seisint.webservices.WsAttributes.AttributeType[] getTypes() {
        return types;
    }
     ...
     * @param types
     */
    public void setTypes(com.seisint.webservices.WsAttributes.AttributeType[] types) {
        this.types = types;
    }
