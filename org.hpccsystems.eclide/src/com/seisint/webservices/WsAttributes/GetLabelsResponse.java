...
public class GetLabelsResponse  implements java.io.Serializable {
    ...
    private com.seisint.webservices.WsAttributes.ECLLabel[] outLabels;
    ...
    public GetLabelsResponse(
           ...
           com.seisint.webservices.WsAttributes.ECLLabel[] outLabels) {
     ...
     * @return outLabels
     */
    public com.seisint.webservices.WsAttributes.ECLLabel[] getOutLabels() {
        return outLabels;
    }
     ...
     * @param outLabels
     */
    public void setOutLabels(com.seisint.webservices.WsAttributes.ECLLabel[] outLabels) {
        this.outLabels = outLabels;
    }
