...
public class OctaveDocumentScanner {
	 ...
	 *            the partition to scan in
	 */
	public OctaveDocumentScanner(IDocument document, String partitioning,
			String partition) {
	 ...
	 *            the document to scan.
	 */
	public OctaveDocumentScanner(IDocument document) {
		this(document, OctavePartitions.ECL_PARTITIONING,
