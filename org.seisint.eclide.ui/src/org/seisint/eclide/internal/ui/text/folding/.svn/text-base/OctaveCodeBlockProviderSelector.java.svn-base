...
public class OctaveCodeBlockProviderSelector extends DLTKIdContributionSelector {

	protected String getSavedContributionId(PreferencesLookupDelegate delegate) 
	{
		 return delegate.getString(OctclipsePlugin.PLUGIN_ID, OctaveCoreConstants.CODE_BLOCK_PROVIDER);
	}
