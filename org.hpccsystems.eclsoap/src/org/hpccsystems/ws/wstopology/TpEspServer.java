...
public class TpEspServer  implements java.io.Serializable {
	...
	private org.hpccsystems.ws.wstopology.TpBinding[] tpBindings;
	...
	public TpEspServer(
			...
			org.hpccsystems.ws.wstopology.TpBinding[] tpBindings) {
		this.name = name;
	 ...
	 */
	  ...
	  * @return tpBindings
	  */
	 public org.hpccsystems.ws.wstopology.TpBinding[] getTpBindings() {
		 return tpBindings;
	 }
	  ...
	  * @param tpBindings
	  */
	 public void setTpBindings(org.hpccsystems.ws.wstopology.TpBinding[] tpBindings) {
		 this.tpBindings = tpBindings;
	 }
