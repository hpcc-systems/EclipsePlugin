...
public class WUJobListResponse  implements java.io.Serializable {
	...
	private org.hpccsystems.ws.wsworkunits.ECLJob[] jobs;
	...
	public WUJobListResponse(
			...
			org.hpccsystems.ws.wsworkunits.ECLJob[] jobs) {
	 ...
	 * @return jobs
	 */
	public org.hpccsystems.ws.wsworkunits.ECLJob[] getJobs() {
		return jobs;
	}
	 ...
	 * @param jobs
	 */
	public void setJobs(org.hpccsystems.ws.wsworkunits.ECLJob[] jobs) {
		this.jobs = jobs;
	}
